...
int main (int argc, char *argv[])
{
  ...
  for (uint32_t i = 0; i < nWifis; ++i)
    {
      ...
      AnimationInterface::SetConstantPosition (backboneNodes.Get (i), 10, 30);
  ...
  AnimationInterface anim ("wifibridging.xml"); // Mandatory
  anim.UpdateNodeColor (backboneNodes.Get (nWifis - 1), 0, 255, 0);
